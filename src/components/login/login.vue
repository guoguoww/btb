    ...
    <div>
      <div id="sign">
        <div class="sign">
          ...
          <p>还不是BCTuickpay的用户？ 立即<router-link to="/register"> 注册 </router-link>，在数字资产交易平台开始交易。</p>
        </div>
      </div>
    </div>
</template>
...
<style scoped>
 ...
 /*滑动解锁css*/
  ...
  .handler_ok_bg{
    ...
    background: #fff url('../../../static/imgs/ok.png') no-repeat center;
  }
  .drag_bg{
