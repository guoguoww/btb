    ...
    <div>
      <div id="sign">
        <div class="sign">
          ...
          <!--阅读协议-->
          <div class="agreement">
            <Checkbox v-model="readAgreement"> 我已阅读并同意BCT</Checkbox>
            <router-link class="agreement_link" to="">《用户协议》</router-link>
          </div>
          <!--按钮区域-->
          <div class="sign-but">
          ...
          <ul class="list-item">
            ...
            <li>• <span _ngcontent-c2="">请妥善保存您的BCTuickpay账号及登录密码。</span></li>
