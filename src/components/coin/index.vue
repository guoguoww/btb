                            ...
                            <li class="maketlist-left " v-for="(i,index) in category" :key="index" :class="{'maketlist-left-bg':i==coinitem}" @click="coinitem=i">
                                ...
                                <div class="list-left">
                                    ...
                                    <div class="list-left-right" >
                                        <h2 class="depreciate-class"  :class="i.diffRate>0?'hong':'lv'">{{i.diffRate?(+i.diffRate).toFixed(4):'----'}}%</h2>
                                        <p  class="depreciate-class" :class="i.diffRate>0?'hong':'lv'">{{i.diff?(+i.diff).toFixed(4):'----'}}</p>
                                    </div>
                                </div>
                                <p class="left-line"></p>
                    ...
                    <div class="price1">
                        ...
                        <div class="price1_top">
                            <ul class="askTable">
                                <li class="" v-for="i in 5" :key="i">
                                    ...
                                    <span>{{marketitem[`bv${i}`]?(+marketitem[`bv${i}`]).toFixed(4):0}}</span>
                        ...
                        <ul class="price1_bottom">
                            <li class="" v-for="i in 5" :key="i">
                                ...
                                <span>{{marketitem[`sv${i}`]?(+marketitem[`sv${i}`]).toFixed(4):0}}</span>
