        ...
        <div id="newAssets">
            ...
            <div class="ass-switch" v-show="curIndex == 0">
                <div class="ass-money clear">
                    <div class="ass-money-li" v-for="(item, index) of assetsInfos" :key="index" @click="assetsClick(item.assetsType, item.assetsType)" v-if="index < 3">
                        <div class="money-li-cont">
                            <span>{{item.assetsType == 0? 'C2C': item.assetsType == 1? '币币':item.assetsType == 2? '合约': ''  }}资产估值 (BTC)</span>
                            <h6>{{item.btc}}</h6>
                            <em>≈{{item.cny}} CNY</em>
                        </div>
                    ...
                    <div class="ass-list-tab" >
                        <table border="0" cellspacing="0" cellpadding="0" >
                            ...
                            <tr v-for="(item, index) of assetsCurInfos" :key="index" v-show="initShow">
                                ...
                                <td>
                                    <router-link to="/chargeIn" v-show="assetsIndex == 0">充币</router-link>
                                    <router-link to="/moneyOut" v-show="assetsIndex == 0">提币</router-link>
                                    <router-link :to="assetsIndex == 0?'/c2c': assetsIndex == 1?'/coin': assetsIndex == 2?'/contract':'/'">交易</router-link>
    ...
    export default {
        ...
        methods: {
            ...
            assetsClick(index, assetsType){//资产中的交易账户三个资产切换
                ...
                this.accountId = assetsType;
                this.assetsIndex = index;
                this.currency = assetsType == 0?'C2C': assetsType == 1?'币币': assetsType == 2?'合约': assetsType == 3?'佣金':'';
            ...
            showHide(){//多选框的选中操作
                ...
                this.getAssetsQuery(this.accountId);
