        ...
        <div class="container">
            ...
            <div class="dw-body">
                <div class="lists-type">
                    <span v-for="(item, index) of titleInfo" :key="index" @click="toggleTab(item.val)" :class="{cur: getTypeNum == item.val}">{{item.name}}</span>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            toggleTab(index){//切换充值提现tab
                ...
                this.$router.push(`${this.$route.path}?typeNum=${index}`)
